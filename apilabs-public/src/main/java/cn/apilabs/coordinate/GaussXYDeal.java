...
public class GaussXYDeal {
     ...
     * @param X        大地坐标
     * @param Y        大地坐标
     * @param zbx      80(西安80)、54
     * @param ZoneWide 带宽. 3(3度带)、6(6度带)
     * @return [longitude, latitude]
     */
    public static double[] gaussToBL(double X, double Y, String zbx, int ZoneWide) {
        int ProjNo;
...
//        ZoneWide = 6; //6度带宽
        ...
        //System.out.println("x：" + X + ",y：" + Y + ",zbx：" + zbx);
        return output;
    ...
    public static void main(String[] args) {
        double[] doubles = GaussXYDeal.gaussToBL(18759022.6, 4090918.5, "80", 6);
